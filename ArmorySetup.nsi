...
VIAddVersionKey ProductName "Protoshares Armory"
...
Section -Main SEC0000
    ...
    SetOutPath $DESKTOP
    CreateShortcut "$DESKTOP\Protoshares Armory.lnk" $INSTDIR\ArmoryQt.exe
    !insertmacro CREATE_SMGROUP_SHORTCUT "Protoshares Armory" "$INSTDIR\ArmoryQt.exe" ""
    !insertmacro CREATE_SMGROUP_SHORTCUT "Protoshares Armory (Offline)" "$INSTDIR\ArmoryQt.exe" "--offline"
    !insertmacro CREATE_SMGROUP_SHORTCUT "Protoshares Armory (testnet)" "$INSTDIR\ArmoryQt.exe" "--testnet"
...
Section /o -un.Main UNSEC0000
    !insertmacro DELETE_SMGROUP_SHORTCUT "Protoshares Armory (testnet)"
    !insertmacro DELETE_SMGROUP_SHORTCUT "Protoshares Armory (Offline)"
    !insertmacro DELETE_SMGROUP_SHORTCUT "Protoshares Armory"
    Delete /REBOOTOK "$DESKTOP\Protoshares Armory.lnk"
