...
print ''
print 'Breakdown of SatoshiDice profit for bets of size: %0.2f PTS' % amt
print '"House Edge" (actual edge is 1/2 this):           %0.1f%%' % (100*(1-E))
print 'Standard fee per return transaction:              %0.4f PTS' % F
...
print ''
print 'Breakdown of SatoshiDice profit for *%d* bets:  %0.2f PTS each' % (nBet,amt)
print '"House Edge" (actual edge is 1/2 this):            %0.1f%%' % (100*(1-E))
print 'Standard fee per return transaction:               %0.4f PTS' % F
print 'Target'.rjust(10), 'Avg Profit'.rjust(12), '1-sigma'.rjust(12), '3-sigma'.rjust(12)
print '-'*50
